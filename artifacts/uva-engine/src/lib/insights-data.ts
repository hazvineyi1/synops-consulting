export const insightsData = [
  {
    ...
    excerpt: "How redesigning escalation frameworks can save millions in high-dollar claim remediation and reduce dispute times by 40%.",
    body: [
      "In managed care, provider dispute resolution is often a bottleneck that frustrates network partners and ties up internal resources. High-dollar claims can sit in limbo for months, leading to strained relationships and operational inefficiency.",
      "Our recent analysis of a large Medicaid MCO revealed that 60% of disputes were caused by repetitive, systemic errors in the initial claims processing, combined with an opaque escalation pathway. By implementing a root-cause analysis framework and standardizing the dispute intake process, we were able to significantly reduce the backlog.",
      "Key to this redesign was establishing clear Service Level Agreements (SLAs) for different tiers of disputes and empowering front-line staff with better decision-making guidelines. The result: a 40% reduction in average resolution time and a noticeable improvement in provider satisfaction scores."
    ]
  },
  {
    slug: "designing-accessible-online-courses",
  ...
  {
    slug: "where-ai-helps-and-doesnt",
    title: "Where AI helps (and where it doesn't) in adaptive learning.",
    author: "Belinda H. Musoni",
    date: "2024-04-20",
    practice: "Platforms & SaaS",
    excerpt: "Navigating the hype: a pragmatic look at applying large language models to educational technology.",
    body: [
